//
//  FileSystemRepositoryManagerSettings.cs
//
//  Author:
//       Moduni contributors
//
...
namespace Moduni
{
    public class FileSystemRepositoryManagerSettings : ARepositoryManagerSettings
    {
        [XmlElement("FolderPath")]
        public string folderPath;

        public FileSystemRepositoryManagerSettings()
        {
